Asteroids Reimagined Alpha 4.22.5 released.
...
Bug Fixes. Player ship spawns after Game Over. Flame visible after hit if player was thrusting. Hitting UFO gave no score. Fixed Boss after wave five has HP, and correct color/alpha. Fixed Secondary shots not hitting mines. Boss does not spawn if Death Star or fighters are still active.